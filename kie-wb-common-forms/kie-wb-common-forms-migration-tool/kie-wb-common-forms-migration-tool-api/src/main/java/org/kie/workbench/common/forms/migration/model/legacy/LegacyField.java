 ...
 */
@Portable
public class LegacyField implements Serializable,
                                    Comparable<LegacyField> {
    ...
    private Map errorMessage = new HashMap<>();;
    ...
    private Boolean groupWithPrevious = Boolean.FALSE;
    ...
    private Map htmlContent = new HashMap<>();;
    ...
    private Map newItemText = new HashMap<>();
    private Map addItemText = new HashMap();
    private Map cancelItemText = new HashMap();
    ...
    public Map getNewItemText() {
        return newItemText;
    }

    public void setNewItemText(Map newItemText) {
        this.newItemText = newItemText;
    }

    public Map getAddItemText() {
        return addItemText;
    }

    public void setAddItemText(Map addItemText) {
        this.addItemText = addItemText;
    }

    public Map getCancelItemText() {
        return cancelItemText;
    }

    public void setCancelItemText(Map cancelItemText) {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LegacyField)) {
            return false;
        }
        LegacyField castOther = (LegacyField) other;
    ...
    public void setHtmlContent(Map htmlContent) {
    ...
    public Map asMap() {
        ...
        value.put("fieldName",
                  getFieldName());
        value.put("fieldRequired",
                  getFieldRequired());
        value.put("groupWithPrevious",
                  getGroupWithPrevious());
        value.put("height",
                  getHeight());
        value.put("labelCSSClass",
                  getLabelCSSClass());
        value.put("labelCSSStyle",
                  getLabelCSSStyle());
        value.put("label",
                  getLabel());
        value.put("errorMessage",
                  getErrorMessage());
        value.put("title",
                  getTitle());
        value.put("readonly",
        ...
        value.put("formula",
                  getFormula());
        value.put("rangeFormula",
                  getRangeFormula());
        value.put("pattern",
                  getPattern());
        value.put("maxlength",
                  getMaxlength());
        value.put("styleclass",
                  getStyleclass());
        value.put("cssStyle",
                  getCssStyle());
        value.put("tabindex",
        ...
        value.put("isHTML",
                  getIsHTML());
        value.put("hideContent",
                  getHideContent());
        value.put("defaultValueFormula",
                  getDefaultValueFormula());
        value.put("htmlContent",
                  getHtmlContent());

        value.put("inputBinding",
                  getInputBinding());
        value.put("outputBinding",
                  getOutputBinding());

        //SubForms
        value.put("defaultSubform",
                  getDefaultSubform());
        value.put("previewSubform",
                  getPreviewSubform());
        value.put("tableSubform",
                  getTableSubform());

        value.put("newItemText",
                  getNewItemText());
        value.put("addItemText",
                  getAddItemText());
        value.put("cancelItemText",
                  getCancelItemText());

        value.put("deleteItems",
                  getDeleteItems());
        value.put("updateItems",
                  getUpdateItems());
        value.put("visualizeItem",
                  getVisualizeItem());
        value.put("hideCreateItem",
                  getHideCreateItem());

        return value;
    }

    public int compareTo(LegacyField o) {
    ...
    public static class Comparator implements java.util.Comparator {
        ...
        public int compare(Object o1,
                           Object o2) {
            LegacyField f1 = (LegacyField) o1;
            LegacyField f2 = (LegacyField) o2;
