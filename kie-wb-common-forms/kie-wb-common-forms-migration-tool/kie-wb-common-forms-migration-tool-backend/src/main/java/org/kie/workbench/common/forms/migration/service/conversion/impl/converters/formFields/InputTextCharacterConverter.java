...
@Dependent
public class InputTextCharacterConverter extends AbstractField2FieldDefinitionConverter {

    @Override
    protected Map<String, String> getTypeBindings() {
        Map<String, String> bindings = new HashMap<>();

        bindings.put("InputTextCharacter",
                     Character.class.getName());
        bindings.put("InputTextPrimitiveCharacter",
                     char.class.getName());
