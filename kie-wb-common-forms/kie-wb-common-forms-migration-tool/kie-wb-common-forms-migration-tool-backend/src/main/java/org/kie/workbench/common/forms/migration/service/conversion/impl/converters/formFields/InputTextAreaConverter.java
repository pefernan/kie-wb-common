...
@Dependent
public class InputTextAreaConverter extends AbstractField2FieldDefinitionConverter {
    ...
    protected FieldDefinition doConvert(LegacyField legacyField) {
        ...
        new NotNullParamSetter<>(legacyField.getHeight(), height -> textAreaFieldDefinition.setRows(Integer.decode(height))).run();
