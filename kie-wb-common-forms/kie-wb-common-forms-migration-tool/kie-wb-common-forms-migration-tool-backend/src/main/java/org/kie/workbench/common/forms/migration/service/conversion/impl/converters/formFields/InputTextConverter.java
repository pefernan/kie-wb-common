...
@Dependent
public class InputTextConverter extends AbstractField2FieldDefinitionConverter {
    ...
    protected FieldDefinition doConvert(LegacyField legacyField) {
        ...
        new NotNullParamSetter<>(legacyField.getMaxlength(), maxLengh -> textBoxFieldDefinition.setMaxLength(maxLengh.intValue())).run();
