...
@Dependent
public class InputDateConverter extends AbstractField2FieldDefinitionConverter {
    ...
    protected FieldDefinition doConvert(LegacyField legacyField) {
        ...
        fieldDefinition.setShowTime(legacyField.getFieldType().equals("InputDate"));
    ...
    protected Map<String, String> getTypeBindings() {
        ...
        bindings.put("InputDate",
                     Date.class.getName());
        bindings.put("InputShortDate",
                     Date.class.getName());
