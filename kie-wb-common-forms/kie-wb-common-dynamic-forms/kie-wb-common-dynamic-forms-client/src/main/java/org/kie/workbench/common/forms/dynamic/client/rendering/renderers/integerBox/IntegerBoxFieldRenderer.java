...
package org.kie.workbench.common.forms.dynamic.client.rendering.renderers.integerBox;
...
public class IntegerBoxFieldRenderer extends FieldRenderer<IntegerBoxDefinition> {
    ...
    public void initInputWidget() {
        longBox = new LongBox();
        longBox.getElement().setId(field.getId() );
        longBox.getElement().setAttribute("placeholder", field.getPlaceHolder());
        longBox.getElement().addClassName("form-control");
