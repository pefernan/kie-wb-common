...
import org.kie.workbench.common.forms.dynamic.client.rendering.layouts.multiple.AbstractMultipleLayoutDisplayer;
import org.kie.workbench.common.forms.dynamic.client.rendering.layouts.simple.basic.displayer.BasicLayoutDisplayer;

@Dependent
public class AccordionDisplayer extends AbstractMultipleLayoutDisplayer<AccordionDisplayerView> {

    @Inject
    public AccordionDisplayer(AccordionDisplayerView view,
