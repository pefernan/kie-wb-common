...
@Dependent
public class IntegerBoxFieldProvider extends BasicTypeFieldProvider<IntegerBoxDefinition> {
    ...
    @Override
    public IntegerBoxDefinition getDefaultField() {
        return new IntegerBoxDefinition();
    }

    @Override
    public IntegerBoxDefinition createFieldByType(FieldDataType typeInfo) {
