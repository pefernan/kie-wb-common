...
%>
<i18n:bundle id="bundle" baseName="org.kie.workbench.common.forms.client.resources.i18n.LoginConstants"
             locale='<%= locale%>' />
...
<head>
  ...
  <title><i18n:message key="LoginTitle">Forms Showcase</i18n:message></title>
</head>
