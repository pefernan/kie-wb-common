 ...
 */
package org.kie.workbench.common.forms.client;
...
import org.kie.workbench.common.forms.client.home.HomeProducer;
...
@EntryPoint
public class FormsShowcaseEntryPoint extends DefaultWorkbenchEntryPoint {
    ...
    @Inject
    public FormsShowcaseEntryPoint(Caller<AppConfigService> appConfigService,
    ...
    @PostConstruct
    public void init() {
        workbench.addStartupBlocker( FormsShowcaseEntryPoint.class );
        homeProducer.init();
        ...
        socialConfigurationService.call( new RemoteCallback<Boolean>() {
            public void callback( final Boolean socialEnabled ) {
                ...
                userSystemManager.waitForInitialization( () -> {
                    ...
                    workbench.removeStartupBlocker( FormsShowcaseEntryPoint.class );
