...
@Portable
public class DeferredCompositeCommandInitializationContext implements InitializationContext {

    private boolean reverse;
    private List<InitializationContext> contexts = new ArrayList<>();

    public DeferredCompositeCommandInitializationContext(@MapsTo("reverse") boolean reverse) {
    ...
    public DeferredCompositeCommandInitializationContext addCommand(InitializationContext context) {
